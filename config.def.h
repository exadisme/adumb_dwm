...
static const char *fonts[]          = { "UbuntuMono-R:size=13" };
...
static const char *volucmd[]  = { "pactl", "set-sink-volume", "@DEFAULT_SINK@", "+10%", NULL }; 
static const char *voldcmd[]  = { "pactl", "set-sink-volume", "@DEFAULT_SINK@", "-10%", NULL }; 
static const char *volmcmd[]  = { "pactl", "set-sink-volume", "@DEFAULT_SINK@", "0%", NULL }; 
